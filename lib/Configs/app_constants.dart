...
// final starchatBlack = new Color(0xFF1E1E1E);
// final starchatBlue = new Color(0xFF02ac88);
// final starchatDeepGreen = new Color(0xFF01826b);
// final starchatLightGreen = new Color(0xFF02ac88);
// final starchatgreen = new Color(0xFF098b74);
// final starchatteagreen = new Color(0xFFe9fedf);
// final starchatWhite = Colors.white;
// final starchatGrey = Color(0xff85959f);
// final starchatChatbackground = new Color(0xffe8ded5);
...
final starchatBlack = new Color(0xFF353f58);
final starchatBlue = new Color(0xFF3d9df5);
final starchatDeepGreen = new Color(0xFF296ac6);
final starchatLightGreen = new Color(0xFF036eff);
final starchatgreen = new Color(0xFF06a2ff);
final starchatteagreen = Color(0xFFeefcf8);
final starchatWhite = Colors.white;
final starchatGrey = Colors.grey;
final starchatChatbackground = new Color(0xffdde6ea);
...
//Also don't forget to Change the Admob App Id in "starchat/android/app/src/main/AndroidManifest.xml" & "starchat/ios/Runner/Info.plist"
...
//*--App Configurations---
const Appname =
    'starchat'; //app name shown evrywhere with the app where required
