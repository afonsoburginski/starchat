...
import 'package:starchat/Screens/Broadcast/BroadcastDetails.dart';
...
import 'package:starchat/widgets/DocumentPicker/documentPicker.dart';
...
class _BroadcastChatPageState extends State<BroadcastChatPage>
      ...
      tiles.add(ListTile(
          ...
          onTap: () async {
            ...
            await FirebaseFirestore.instance
                ...
                .delete();
            starchat.toast(getTranslated(this.context, 'deleted'));
          }));
    }
  ...
  Future<Position> _determinePosition() async {
    ...
    if (permission == LocationPermission.always ||
      ...
      starchat.toast(getTranslated(this.context, 'detectingloc'));
    }
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
        scaffold: starchat.getNTPWrappedWidget(Consumer<List<BroadcastModel>>(
