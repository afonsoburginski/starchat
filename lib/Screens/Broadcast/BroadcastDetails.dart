...
import 'package:starchat/Screens/Broadcast/EditBroadcastDetails.dart';
...
class _BroadcastDetailsState extends State<BroadcastDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(scaffold: starchat.getNTPWrappedWidget(
