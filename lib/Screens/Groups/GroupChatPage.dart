...
import 'package:starchat/Screens/Groups/GroupDetails.dart';
import 'package:starchat/Screens/Groups/widget/groupChatBubble.dart';
...
//       //----sharing intent action:
  ...
  //                       focusNode: keyboardFocusNode,
  //                       maxLines: null,
  //                       style: TextStyle(fontSize: 16.0, color: starchatBlack),
  //                       controller: textEditingController,
  //                       decoration: InputDecoration(
  //                         enabledBorder: OutlineInputBorder(
  //                           // width: 0.0 produces a thin "hairline" border
  ...
  //                             maxLines: null,
  //                             style: TextStyle(
  //                                 fontSize: 18.0, color: starchatBlack),
  //                             controller: textEditingController,
  //                             decoration: InputDecoration(
  //                               enabledBorder: OutlineInputBorder(
  //                                 // width: 0.0 produces a thin "hairline" border
              ...
              child: GroupChatBubble(
                ...
                child: doc[Dbkeys.groupmsgISDELETED] == true
                    ? Text(
                        ...
                        style: TextStyle(
                            color: starchatBlack.withOpacity(0.6),
                            fontSize: 15,
    ...
    return Positioned(
      child: isgeneratingSomethingLoader
          ? Container(
              ...
              color: DESIGN_TYPE == Themetype.whatsapp
                  ? starchatBlack.withOpacity(0.2)
                  : starchatWhite.withOpacity(0.2),
            )
          : Container(),
    );
  }
