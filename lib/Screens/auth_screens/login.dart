...
import 'package:starchat/widgets/PhoneField/intl_phone_field.dart';
import 'package:starchat/widgets/PhoneField/phone_number.dart';
...
class LoginScreenState extends State<LoginScreen>
  ...
  Future<void> verifyPhoneNumber() async {
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      starchat.toast('Authentication failed - ${authException.message}');
    };
    ...
    final PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
      ...
      starchat.toast('Authentication failed Timeout. please try again.');
    };
    ...
    // } catch (e) {
    //   starchat.toast('NEW CATCH' + e.toString());
    // }
  }
  ...
  Future<Null> handleSignIn({AuthCredential? authCredential}) async {
    ...
    try {
          ...
          if (widget.issecutitysetupdone == false) {
            ...
            unawaited(Navigator.pushReplacement(
                ...
                new MaterialPageRoute(
                    builder: (context) => starchatWrapper())));
            starchat.toast(getTranslated(this.context, 'welcomeback'));
            await subscribeToNotification(documents[0][Dbkeys.phone], false);
          }
        }
      } else {
        starchat.toast(getTranslated(this.context, 'failedlogin'));
      }
    } catch (e) {
      setState(() {
      ...
      if (e.toString().contains('invalid') ||
        ...
        starchat.toast(getTranslated(this.context, 'makesureotp'));
      }
    }
  }
  ...
  void _changeLanguage(Language language) async {
    ...
    starchatWrapper.setLocale(this.context, _locale);
    setState(() {
                  ...
                  decoration: BoxDecoration(
                    boxShadow: [
                      BoxShadow(
                        blurRadius: 3.0,
                        color: DESIGN_TYPE == Themetype.whatsapp
                            ? starchatDeepGreen.withOpacity(0.3)
                            : starchatBlack.withOpacity(0.1),
                        spreadRadius: 1.0,
                      ),
                    ],
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: MobileInputWithOutline(
                            buttonhintTextColor: starchatGrey,
                            borderColor: starchatGrey.withOpacity(0.2),
                            controller: _phoneNo,
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(
                            ...
                            style: TextStyle(
                                height: 1.7,
                                color: DESIGN_TYPE == Themetype.whatsapp
                                    ? starchatWhite.withOpacity(0.79)
                                    : starchatBlack.withOpacity(0.79),
        ...
        children: <Widget>[
          ...
          Center(
            child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(starchatLightGreen)),
          ),
          SizedBox(
            height: 48,
          ),
        ...
        children: <Widget>[
            ...
            child: Padding(
              ...
              child: PinFieldAutoFill(
                ...
                decoration: UnderlineDecoration(
                  bgColorBuilder:
                      FixedColorBuilder(starchatGrey.withOpacity(0.1)),
                  textStyle: TextStyle(
                      fontSize: 22,
                      color: starchatBlack,
                ...
                onCodeSubmitted: (code) {
                  ...
                  if (code.length == 6) {
                    ...
                    starchat.toast(getTranslated(this.context, 'correctotp'));
                  }
                },
                onCodeChanged: (code) {
                  if (code!.length == 6) {
          ...
          isShowCompletedLoading == true
              ? Center(
                  child: CircularProgressIndicator(
                      valueColor:
                          AlwaysStoppedAnimation<Color>(starchatLightGreen)),
                )
              : Padding(
                  padding: EdgeInsets.fromLTRB(17, 22, 17, 5),
                  child: MySimpleButton(
                    ...
                    onpressed: () {
                      if (_code.length == 6) {
                        ...
                        starchat
                            .toast(getTranslated(this.context, 'correctotp'));
                    },
                  ),
                ),
          SizedBox(
                          ...
                          child: RichText(
                            ...
                            children: [
                              TextSpan(
                                ...
                                style: TextStyle(
                                    fontSize: 14, color: starchatGrey),
                              ),
                              TextSpan(
  ...
  Widget build(BuildContext context) {
    ...
    return starchat.getNTPWrappedWidget(Scaffold(
      backgroundColor:
          DESIGN_TYPE == Themetype.whatsapp ? starchatDeepGreen : starchatWhite,
    ...
    return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                color: widget.buttoncolor ?? starchatgreen,
              ),
              borderRadius:
  ...
  BoxDecoration boxDecoration(
    ...
    return BoxDecoration(
        ...
        boxShadow: showShadow
            ? [BoxShadow(color: starchatgreen, blurRadius: 10, spreadRadius: 2)]
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: widget.hintStyle ??
                      TextStyle(
                          ...
                          fontSize: 15.5,
                          fontWeight: FontWeight.w400,
                          color: widget.buttonhintTextColor ?? starchatGrey),
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius:
                          BorderRadius.circular(widget.boxcornerradius ?? 1),
                      borderSide: BorderSide(color: starchatgreen, width: 1.5),
                    ),
