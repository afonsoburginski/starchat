...
import 'package:starchat/Screens/call_history/utils/InfiniteListView.dart';
                            ...
                            actions: [
                              ...
                              FlatButton(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color: starchatgreen, fontSize: 18),
                                ),
                                onPressed: () {
                              ...
                              FlatButton(
                                ...
                                onPressed: () async {
                                  Navigator.of(context).pop();
                                  starchat
                                      .toast(getTranslated(context, 'plswait'));
