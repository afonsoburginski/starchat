...
import 'package:starchat/widgets/InfiniteList/InfiniteCOLLECTIONListViewWidget.dart';
...
class _LazyLoadingChatState extends State<LazyLoadingChat>
  ...
  void initState() {
    ...
    chatId = starchat.getChatId(widget.currentUserNo, widget.peerNo);
...
//       //----sharing intent action:
  ...
  dynamic encryptWithCRC(String input) {
    try {
      ...
      starchat.toast('Error occured while encrypting !');
      return false;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final observer = Provider.of<Observer>(context, listen: true);
    return PickupLayout(
        scaffold: starchat.getNTPWrappedWidget(Consumer<List<GroupModel>>(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: starchat.avatar(peer, radius: 20),
                                  ),
                                  SizedBox(
                                    width: 7,
                                  ),
