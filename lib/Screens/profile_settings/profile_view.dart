...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget build(BuildContext context) {
    ...
    return PickupLayout(
      ...
      backgroundColor:
          DESIGN_TYPE == Themetype.whatsapp ? Color(0xfff2f2f2) : starchatWhite,
      body: ListView(
        children: [
          Stack(
            children: [
              CachedNetworkImage(
                ...
                placeholder: (context, url) => Container(
                  ...
                  child: Icon(Icons.person,
                      color: starchatGrey.withOpacity(0.5), size: 95),
                ),
          ...
          Container(
            ...
            child: ListTile(
              ...
              subtitle: Text(
                ...
                style:
                    TextStyle(color: starchatGrey, height: 1.3, fontSize: 15),
              ),
              trailing: Padding(
