...
import 'package:starchat/Screens/Broadcast/BroadcastChatPage.dart';
import 'package:starchat/Screens/Groups/AddContactsToGroup.dart';
import 'package:starchat/Screens/Groups/GroupChatPage.dart';
import 'package:starchat/Screens/contact_screens/SmartContactsPage.dart';
...
import 'package:starchat/Screens/chat_screen/utils/messagedata.dart';
...
import 'package:starchat/Utils/alias.dart';
...
class RecentChatsState extends State<RecentChats> {
                  ...
                  actions: [
                    ...
                    FlatButton(
                      child: Text(
                        ...
                        style: TextStyle(color: starchatgreen, fontSize: 18),
                      ),
                      onPressed: () {
                    ...
                    FlatButton(
                      ...
                      onPressed: () async {
                        String chatId = starchat.getChatId(
                        ...
                        if (currentUserNo != null &&
                          ...
                          starchat.toast('Error Occured. Could not delete !');
                        }
                      },
                    )
                  ],
    ...
    if (user[Dbkeys.phone] == currentUserNo) {
      ...
      return StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<MessageData> unreadData) {
          ...
          return Theme(
              data: ThemeData(
                  splashColor: starchatGrey.withOpacity(0.2),
  ...
  Stream<MessageData> getUnread(Map<String, dynamic> user) {
    String chatId = starchat.getChatId(currentUserNo, user[Dbkeys.phone]);
  ...
  Widget build(BuildContext context) {
    final observer = Provider.of<Observer>(this.context, listen: false);
    return starchat.getNTPWrappedWidget(ScopedModel<DataModel>(
      model: getModel()!,
      child:
