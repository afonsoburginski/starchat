...
import 'package:starchat/widgets/Passcode/passcode_screen.dart';
...
class _SecurityState extends State<Security> {
  ...
  Widget build(BuildContext context) {
    return starchat.getNTPWrappedWidget(Stack(children: [
      Scaffold(
          appBar: AppBar(
            leading: IconButton(
                onPressed: () {
                ...
                child: myElevatedButton(
                  ...
                  onPressed: () {
                    if (widget.setPasscode) {
                      if (_passCode == null)
                        starchat
                            .toast(getTranslated(this.context, 'setpasscode'));
                      if (
                          // ignore: todo
                        ...
                        var data = {
                          ...
                          // ANSWER:
                          //     starchat.getHashedAnswer(_answer.text),
                          Dbkeys.passcode: starchat.getHashedString(_passCode!)
                        };
                        setState(() {
                          isLoading = true;
                        });
