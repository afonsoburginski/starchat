...
import 'package:starchat/Services/Providers/FirebaseAPIProvider.dart';
        ...
        await FirebaseFirestore.instance
          ...
          try {
            ...
            if (encrypted is String) {
              ...
              if (content.trim() != '') {
                var chatId = starchat.getChatId(currentUserNo, peer);
                await FirebaseFirestore.instance
                    .collection(DbPaths.collectionbroadcasts)
                    .doc(broadcastId)
                    .collection(DbPaths.collectionbroadcastsChats)
            ...
            starchat.toast('Failed to Send message. Error:$e');
          }
        }).catchError(((e) {
          starchat.toast('Failed to Send message. Error:$e');
        }));
