...
import 'package:starchat/Screens/auth_screens/authentication.dart';
...
class ChatController {
  ...
  static block(currentUserNo, peerNo) {
    ...
    FirebaseFirestore.instance
        .collection(DbPaths.collectionmessages)
        .doc(starchat.getChatId(currentUserNo, peerNo))
        .set({'$currentUserNo': DateTime.now().millisecondsSinceEpoch},
            SetOptions(merge: true));
    // starchat.toast('Blocked.');
  }
  ...
  static unhideChat(currentUserNo, peerNo) {
    ...
    // starchat.toast('Chat is visible.');
  }
