...
import 'package:starchat/widgets/AudioRecorder/playButton.dart';
  ...
  Future<void> openTheRecorder() async {
    if (!kIsWeb) {
      ...
      if (status != PermissionStatus.granted) {
        starchat.showRationale(getTranslated(this.context, 'pm'));
                      ...
                      ? _mPlayer!.isPlaying
                          ...
                          : RaisedButton(
                              shape: RoundedRectangleBorder(
                                  ...
                                  side: BorderSide(color: starchatLightGreen)),
                              elevation: 0.2,
