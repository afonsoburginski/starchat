...
class _MultiDocumentPickerState extends State<MultiDocumentPicker> {
  ...
  void captureMultiPageDoc(bool isAddOnly) async {
    ...
    try {
      ...
      starchat.toast('Cannot Send this Document type');
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            overflow: TextOverflow.ellipsis,
                            style:
                                TextStyle(fontSize: 14, color: starchatWhite),
                          ),
                        )
                      ],
                    ),
  ...
  Widget build(BuildContext context) {
    final observer = Provider.of<Observer>(this.context, listen: false);
    return starchat.getNTPWrappedWidget(WillPopScope(
      child: Scaffold(
        backgroundColor:
            DESIGN_TYPE == Themetype.whatsapp ? starchatBlack : starchatWhite,
        appBar: new AppBar(
